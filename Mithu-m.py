...
os.system('espeak -a 300 " Welcome,   to,  Mithu,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/mithuahmed1212')
def banner():
	os.system("clear")
	print (f"""
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-MITHU ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Mithu, King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m Mithu-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01608843956 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.0.1 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801767853679')
	elif TUTUL in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Mithu-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
